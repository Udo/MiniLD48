  ...
  init : function() {
    ...
    uiController.showMessage('<p>Welcome, Dark Lord.</p>'+
      ...
      uiController.showMessage('<p>You must hurry, oh Dark Lord, before the students arrive to Botanomancy class.</p>'+
        '<p>Select the "Muncher" spell by clicking on the "M" in the spell menu and cast it near the body. A muncher is a monster that disposes of inconvenient bodies.</p>'+
...
levelData.push({
  ...
  init : function() {
    ...
    uiController.showMessage('<p>Well done, my lord.</p>'+
      '<p>Now would be a great time for a dark ritual to further your power. You loayal minions have gathered in the Conservatory '+
      'and are preparing to summon the dark plant god Moraster.<p>');
